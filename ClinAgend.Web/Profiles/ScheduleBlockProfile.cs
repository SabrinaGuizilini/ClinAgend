...
{
    internal class ScheduleBlockProfile : Profile
    {
        public ScheduleBlockProfile()
        {
            // Entidade → DTO
            CreateMap<ScheduleBlock, ScheduleBlockDTO>()
            ...
            // DTO → Entidade
            CreateMap<ScheduleBlockDTO, ScheduleBlock>()
                .ForMember(dest => dest.StartTime,
